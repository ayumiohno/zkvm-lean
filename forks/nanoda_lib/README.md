# nanoda (lean-zkvm research fork)

This directory is a source-tracked fork of
[`ammkrn/nanoda_lib`](https://github.com/ammkrn/nanoda_lib), based on upstream
commit `0505569`. In addition to reading the compact in-memory export format,
it contains the dependency tracing and proof-directed declaration-closure
checker used by lean-zkvm. Keeping it here makes changes to the checker part of
the reviewed zkVM image instead of an installation-time patch.
